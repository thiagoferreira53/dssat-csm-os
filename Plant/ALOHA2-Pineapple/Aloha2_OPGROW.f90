!=======================================================================
!  Aloha2_OpGrow, Subroutine, C.H.Porter
!  Generates daily output for Aloha2-Pineapple model
!-----------------------------------------------------------------------
!  REVISION       HISTORY
!  03/28/2017 CHP Written
!=======================================================================
      SUBROUTINE Aloha2_OpGrow (CONTROL, ISWITCH,          &
        BASLFWT, BIOMAS, CRWNWT, EYEWT, FLRWT, FRTWT,     &
        FRUITS, GPP, GPSM, ISTAGE, LAI, LFWT, LN, MDATE,  &
        NSTRES, PLTPOP, RLV, ROOTN,  RTDEP, RTWT, SKWT,   &
        STMWT, STOVN, STOVWT, SWFAC, TURFAC, WTNCAN, SRADGRO,  SUMSRADGRO, SUMSRAD, SUMPARGRO, SUMPAR,    &
        WTNGRN, WTNUP, YRPLT, TMAXGRO, SUMTMAXGRO, SUMTMAX,        &
        VNAM, VWATM, CNAM, TBASE, SUMDTT, DTT, SUMDTTGRO, GDDFR, FBIOM, MAXLAI)    !Output for Overview.OUT 
      ...
      REAL BASLFWT, SKWT, TOPWT, FBIOM, MD2HI, MAXLAI
      REAL STOVN, GRAINN, STOVWT, ROOTN, WTNVEG, WTNGRN, PCNVEG, PCNGRN
      REAL VNAM, VWATM, CNAM, TBASE, DTT, SUMDTT, TMAXGRO, SUMTMAXGRO, TEMPM
      REAL SUMTMAX, TMAX, SUMDTTGRO, SUMSRAD, SRAD, SUMSRADGRO, GDDFR, SUMPAR, SUMPARGRO, SRADGRO  
