...
!       New stage initialization
        ...
        CASE (1)      ! CASE (1)  !First New Leaf
         ...
         GRORT1  = GRORTI*EXP((RGRORT1/1000)*(DAP3+DAP1))
          ...
          LAI         = LAI1                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
      ...
      CASE (2)       !CASE (2)    ! Leaf Cycle 1
          ...
          PARGRO  = (SUMPARGRO - SUMPAR)/(DAP5)
             ...
             LAI         = LAI2                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
        ...
        CASE (3)      !CASE (3) !Leaf cycle 2
          ...
          PARGRO  = (SUMPARGRO - SUMPAR)/(DAP7)
             ...
             LAI         = LAI3                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
...
!          ENDIF
          ...
          PARGRO  = (SUMPARGRO - SUMPAR)/(DAP9)
             ...
             LAI         = LAI4                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
...
!CHP 10/14/2017          FLRWT  =  0.1*STMWT           ! FLRWT stands for the weight ofwhole inflorescence STMWT is stem weight.  Both are in gram/plant.
        ...
        CASE (7)       ! CASE (7)                  !   CASE (5)
          ...
          PARGROS7  = PARGRO
             ...
             LAI         = LAI7                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
...
!     change ratios to add up to 1, maintaining approximately the same ratio.
        ...
        CASE (8)    !CASE (8)                    !   CASE (5)  JVJ  Case duplicated because 1 stage in reproductive phase were included 
          ...
          PARGROS8  = PARGRO
             ...
             LAI         = LAI8                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
...
!     change ratios to add up to 1, maintaining approximately the same ratio.
        ...
        CASE (9)       !CASE (9)                            ! CASE (6)
          ...
          PARGROS9  = PARGRO
             ...
             LAI         = LAI9                         !ESTAS 8 FILAS DEBEN ESTAR AQUI PARA QUE SALGAN EN EL OVERVIEW PRIMERA PARTE
