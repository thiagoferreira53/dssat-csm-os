...
C-----------------------------------------------------------------------
      ...
      IMPLICIT NONE
      EXTERNAL ALOHA_PINEAPPLE, ALOHA2_PINEAPPLE,BS_CERES,CROPGRO,
     &  CSCAS_INTERFACE, CSCERES_INTERFACE,CSCRP_INTERFACE,CSP_CASUPRO,
     &  CSYCA_INTERFACE, FIND,FORAGE,GETLUN,ML_CERES,MZ_CERES,PT_SUBSTOR,
     &  READ_ASCE_KT, RICE,SAMUCA,SC_CNGRO,SG_CERES,SU_CERES,SUMVALS,TEFF,
     &  TF_APSIM, TR_SUBSTOR,WARNING,WH_APSIM
